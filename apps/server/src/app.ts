...
import { insertEvent, getFilterOptions, getRecentEvents, updateEventHITLResponse, getChartData, isConnected } from './db'
...
// Store WebSocket clients (populated by index.ts WebSocket setup)
...
// Factory function that creates and configures the Hono app
